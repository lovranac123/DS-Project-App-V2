...
df_perf = pd.read_csv('C:/Data Science Project/data/data_aggr_page_id.csv', parse_dates=['date_max', 'date_min'])
df_scrape = pd.read_csv('C:/Data Science Project/data/data_scraped.csv')
df_clickbait = pd.read_csv('C:/Data Science Project/data/clickbait.csv')
# df_trend_match = pd.read_csv('data/data_trends_classified.csv')
df_video_widget = pd.read_csv('C:/Data Science Project/data/video_player_types_per_article.csv')
...
df_full.to_csv('C:/Data Science Project/data/data_features.csv', encoding='utf-8', index=False)
print('The full dataframe with features is saved as C:/Data Science Project/data/data_features.csv')
