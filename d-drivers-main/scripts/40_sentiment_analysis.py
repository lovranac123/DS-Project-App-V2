...
df = pd.read_csv('C:/Data Science Project/data/data_features_gt.csv')
...
df.to_csv('C:/Data Science Project/data/data_nlp.csv', encoding='utf-8', index=False)
print('The full dataframe with features is saved as C:/Data Science Project/data/data_nlp.csv')
