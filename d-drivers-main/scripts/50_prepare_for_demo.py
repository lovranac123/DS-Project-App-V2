...
if not os.path.exists('C:/Data Science Project/data/sl_app'):
        os.makedirs('C:/Data Science Project/data/sl_app')
...
df_features.to_csv('C:/Data Science Project/data/sl_app/eda_scatters.csv', index=False)
...
authors_map = json.load(open('C:/Data Science Project/data/authors.json', 'r', encoding='utf-8'))
...
df_overview.to_csv('C:/Data Science Project/data/sl_app/eda_total.csv', index=False)
...
df_history = pd.read_csv('C:/Data Science Project/data/data_aggr.csv', parse_dates=['date', 'publish_date'], usecols=version_user_side_ftrs)
...
df_history.to_csv('C:/Data Science Project/data/sl_app/dynamics.csv', index=False)
