...
df = pd.read_csv('C:/Data Science Project/data/merged_data.csv', parse_dates=['date', 'publish_date'])
...
# Ensure all values in the 'authors' column are strings and handle NaN values
#df_aggr_authors['authors'] = df_aggr_authors['authors'].fillna('').astype(str)
df_aggr_authors.loc[:, 'authors'] = df_aggr_authors['authors'].fillna('').astype(str)


print(df_aggr_authors['authors'])
...
#url_col['url'] = url_col['url'].fillna('').astype(str)
url_col.loc[:, 'url'] = url_col['url'].fillna('').astype(str)
...
df.to_csv('C:/Data Science Project/data/data_aggr.csv', index=False)

print('Aggregated data saved as "C:/Data Science Project/data/data_aggr.csv" ')
print()
