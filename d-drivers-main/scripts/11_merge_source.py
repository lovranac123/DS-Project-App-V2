...
#df1 = pd.read_excel('C:/Data Science Project/data/data_d-drivers_2024-03-24.xlsx', sheet_name='data',
...
df2 = pd.read_csv('C:/Data Science Project/data/data_d-drivers_2024-07-22.csv'#, sheet_name='data',
...
df2.rename({
           ...
           'page_canonical_url': 'url',
           'page_author': 'authors',
           'discover_clicks': 'external_clicks',
           'discover_impressions':'external_impressions' 
            }, axis=1, inplace=True)
...
### Imputing ###
print('Imputing...')
df = df2.sort_values(['page_id', 'date', 'publish_date', 'url'])\
...
df_imputed['authors'] = df_imputed['authors'].astype(str).fillna('')
...
df_imputed.to_csv('C:/Data Science Project/data/merged_data.csv', encoding='utf-8', index=False)
